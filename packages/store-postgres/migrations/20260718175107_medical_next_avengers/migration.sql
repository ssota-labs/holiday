...
CREATE INDEX "recurring_income_by_deposit" ON "recurring_income" ("deposit_account_id");--> statement-breakpoint
ALTER TABLE "recurring_income" ADD CONSTRAINT "recurring_income_income_account_id_account_id_fkey" FOREIGN KEY ("income_account_id") REFERENCES "account"("id");--> statement-breakpoint
ALTER TABLE "recurring_income" ADD CONSTRAINT "recurring_income_deposit_account_id_account_id_fkey" FOREIGN KEY ("deposit_account_id") REFERENCES "account"("id");--> statement-breakpoint
