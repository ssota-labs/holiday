 ...
 */
export const recurringIncome = sqliteTable(
  'recurring_income',
  {
    id: text('id').primaryKey(),
    label: text('label').notNull(),
 ...
 */
export const taxReturn = sqliteTable(
  'tax_return',
  {
    id: text('id').primaryKey(),
...
export const taxReturnLine = sqliteTable(
  'tax_return_line',
  {
 ...
 */
export const insuranceEnrollment = sqliteTable(
 ...
 */
export const insuranceContribution = sqliteTable(
...
export const insuranceContributionLine = sqliteTable(
